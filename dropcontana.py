...
for j in range(900, 2820, 5):
    ...
    ob = bpy.data.objects['drop']
    matd=bpy.data.materials.new(name="dropmaterial")
    ob.data.materials.append(matd)
    ...
    ob = bpy.data.objects['cont']
    matw=bpy.data.materials.new(name="contmaterial")
    ob.data.materials.append(matw)
    ...
    bpy.context.scene.render.filepath=filnamload+'\datat ('+str(951)+').png'
